...
{% hint style="info" %}
You can customise raid colours in the <a href="palettes.md">Palette</a> tab under the <strong>Raid Zone Effects</strong> category.
{% endhint %}
...
{% hint style="warning" %}
Always close Chromatics before editing <code>effects.chromatics4</code> by hand, or Chromatics will overwrite your changes the next time it saves.
{% endhint %}
